    ...
    <nav class="bg-white shadow-lg">
        <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="myCourses.php" class="hover:text-indigo-600">Mes cours</a>
    ...
    <main class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white p-6 rounded-xl shadow-sm">
                <h2 class="text-lg font-semibold mb-2">Cours suivis</h2>
                <p class="text-2xl font-bold text-indigo-600"><?= count($courses) ?></p>
            </div>
        
        </div>

        <!-- Liste des cours récents -->
        <h2 class="text-2xl font-bold mb-4">Mes cours récents</h2>
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all">
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <a 
                                    href="myCourses.php?action=view_course&id=<?= $course['id'] ?>" 
